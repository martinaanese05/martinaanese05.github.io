...
const ProjectContent = () => {
  ...
  const content = {
    ...
    de: {
      title: "Vierbeiniger Roboter V1",
      overview: "Überblick",
      overviewText: "Der vierbeinige Roboter V1 stellt meinen ersten tiefen Einstieg in die komplexe Robotik dar und wurde im September 2023 begonnen. Was als natürliche Weiterentwicklung einfacherer Projekte begann, entwickelte sich zu einem autonomen, vierbeinigen Roboter mit 12 Freiheitsgraden. Diese Version konzentriert sich auf den Übergang von einem Konzept zu einem funktionsfähigen, batteriebetriebenen Roboter, der mittels eigens entwickelter inverser Kinematik laufen kann.",
      overviewText2: "Die V2 befindet sich derzeit in der Entwicklung und zielt darauf ab, ROS-2-Simulationen, eine Controller-Schnittstelle und Computer Vision zu integrieren.",
      design: "Design des Beins und des Körpers",
      designText: "Entworfen in Fusion 360, musste das Chassis strukturelle Steifigkeit mit Gewichtseffizienz in Einklang bringen. Ich entwickelte vier verschiedene Bein-Prototypen, bevor ich das endgültige Design erreichte: frühe Versionen waren entweder zu klobig und fügten unnötige Trägheit hinzu, oder zu instabil, wodurch die Beine unter dem Gewicht der 12 Servos nachgaben. Die endgültige Iteration verwendet eine schlanke, verstärkte Geometrie, die es den Servos ermöglicht, in ihrem optimalen Drehmomentbereich zu arbeiten.",
      designText2: "Während der anfänglichen Entwicklungsphase verwendete ich eine Holzplattform, um die Komponenten unterzubringen, sodass ich mich vollständig auf die Bein-Kinematik konzentrieren konnte. Sobald die Bewegung perfektioniert war, entwarf und druckte ich einen speziell angefertigten Körper in 3D, der alle elektronischen Teile organisiert und Befestigungspunkte für eine Kamera und ein Touch-Display für die V2 enthält.",
      ...
      step1Text: "Mithilfe von Trigonometrie und Geometrie abgeleitete Gleichungen ermöglichen es, den Fuß zu bestimmten (x, y, z)-Koordinaten zu befehligen.",
      step2: "2. Echtzeitberechnung",
      step2Text: "Der Code berechnet in Echtzeit die notwendigen Winkel für die drei Motoren jedes Beins, um die gewünschte Position zu erreichen.",
      step3: "3. Mögliche Bewegungen",
      step3Text: "Durch inverse Kinematik ist der Roboter in der Lage, auf Befehl vorwärts, rückwärts und seitwärts zu laufen.",
      captionV1: "Version 1.1 beim Laufen.",
      captionV2: "Präsentation der Version V1.1 im Asperastra Innovation Lab.",
